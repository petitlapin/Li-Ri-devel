...
#declare Loco=union {
	 ...
	 // Bords de la loco
	 box { <-5,0,-10> <-4,4,10> texture { Bois_Bleu } }
	 box { <4,0,-10> <5,4,10> texture { Bois_Bleu } }
	 box { <-4,0,-10> <4,4,-9> texture { Bois_Bleu rotate <0,90,0> } }
	 box { <-4,0,10> <4,4,9> texture { Bois_Bleu rotate <0,90,0> } }

	 // Met les balles
	 sphere { <0,0,-5>,3.5 texture { Bois_Rouge } rotate <0,0,35> translate <sin(Avance*M_PI*2)*0.5,3.5,cos(Avance*M_PI*2)*0.3> }
	 sphere { <0,0,5>,3.5 texture { Bois_Vert } rotate <0,0,178> translate <sin(Avance*-M_PI*2)*0.5,3.5,sin(Avance*M_PI*2)*0.2> }
}
