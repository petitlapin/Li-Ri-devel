...
#declare Loco=union {
	 ...
	 // Fait la citerne
	 union {
	       cylinder { <0,4,-8> <0,4,8>,4 }
	       sphere { <0,4,0>,4 scale <1,1,0.3> translate <0,0,-8> }
	       sphere { <0,4,0>,4 scale <1,1,0.3> translate <0,0,8> }
	       texture { Bois_Vert }
	 }
	 cylinder { <0,4,4> <0,9,4>,2.3 texture { Bois_Rouge rotate <90,0,0> } }
	 cylinder { <0,4,-4> <0,9,-4>,2.3 texture { Bois_Jaune rotate <90,0,0> } }

	 cylinder { <0,0.8,-4> <0,0.8,4>,0.8 texture { Bois_Bleu } translate <-3.6,0,0> }
	 cylinder { <0,0.8,-4> <0,0.8,4>,0.8 texture { Bois_Bleu } translate <3.6,0,0> }
}
